...
- **FR-9.1** Maintain problem graph as source of truth in an **embedded graph engine** under `./.openpfe/graph/` ([specification.md](./specification.md), [graph-db-evaluation.md](./graph-db-evaluation.md)).
